...
tape( 'main export is a function', function test( t ) {
	...
	t.strictEqual( typeof itermin, 'function', 'main export is a function' );
	t.end();
});
...
tape( 'the function computes the minimum value', function test( t ) {
	var arr;
	var v;
